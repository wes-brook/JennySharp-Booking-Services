  ...
  var M,
    ...
    n =
      (((t = CustomEase.prototype).setData = function setData(e, t) {
        ...
        for (n = g.length, r = 0; r < n; r++) (h = g[r]), (u = g[r - 1] || h), (h.x > u.x || (u.y !== h.y && u.x === h.x) || h === u) && h.x <= 1 ? ((u.cx = h.x - u.x), (u.cy = h.y - u.y), (u.n = h), (u.nx = h.x), p && 1 < r && 2 < Math.abs(u.cy / u.cx - g[r - 2].cy / g[r - 2].cx) && (p = 0), u.cx < l && (u.cx ? (l = u.cx) : ((u.cx = 0.001), r === n - 1 && ((u.x -= 0.001), (l = Math.min(l, 0.001)), (p = 0))))) : (g.splice(r--, 1), n--);
